...
### Stato Live — v2.9.0 | Sessione #22 | 31 May 2026 04:07
...
- MAPPA drill-down v2.0 + RETE t-SNE 3D (Three.js raw) + watchdog psutil + lazy loading (30 Mag 2026)
- ScreenAgent v1.0 - screenshot + griglia puntini rossi 20x15 + Claude vision + click simulato + copy/drag/hotkey (30 Mag 2026)
- ARGUS v2.0 - architettura ibrida OmniParser+Sonnet: L1 YOLO+OCR locale, L2 text matching, L3 Sonnet fallback - costo API -80% (30 Mag 2026)

### Episodi recenti
- *ARGUS v2.0 - architettura ibrida OmniParser+Sonnet*
- *ScreenAgent v1.0 - screenshot + griglia puntini ro*
- *MAPPA drill-down v2.0 + RETE t-SNE 3D (Three.js ra*
